...
import { RegionAgenciesSection } from '@/components/country/RegionAgenciesSection';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-center px-4">
          ...
          <p className="text-muted-foreground">The requested region page does not exist.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <section className="relative min-h-[90svh] md:min-h-[95vh] flex flex-col items-center justify-center pt-20 sm:pt-24 md:pt-28 pb-16 sm:pb-20 md:pb-24 overflow-hidden">
        ...
        <div className="container-main relative z-10 text-center max-w-5xl mx-auto px-4 sm:px-6">
          ...
          >
            {content.title || `Fostering Agencies in ${regionName}`}
          </motion.h1>
...
const RegionPage = () => {
  ...
  if (!region) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-background">
        <div className="text-center px-4">
          <h1 className="text-2xl font-bold text-destructive mb-2">Region not specified</h1>
          <p className="text-muted-foreground">Please provide a region slug.</p>
        </div>
      </div>
    );
  }
