      ...
      <div className="min-h-screen flex flex-col bg-background">
        ...
        <main className="flex-1 pt-28 flex items-center justify-center">
          <div className="text-center">
            ...
            <Button asChild>
              <Link to="/specialisms">View All Specialisms</Link>
            </Button>
          </div>
        </main>
        <Footer />
            ...
            {loadingAgencies ? (
              ...
              <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                {agencies.map((agency: any, index: number) => (
                  ...
                  >
                    <Link to={`/agencies/${agency.slug}`} className="block group">
            ...
            {agencies && agencies.length > 0 && (
              <div className="text-center mt-12">
                <Button variant="outline" size="lg" className="rounded-full" asChild>
                  <Link to={`/agencies?specialism=${specialism.slug}`}>
                    View All Agencies
                    <ArrowRight className="w-4 h-4 ml-2" />
                  </Link>
                </Button>
        ...
        <section className="section-padding bg-background-sand">
          <div className="container-main">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              <Link to="/specialisms/therapeutic-fostering" className="badge-pill hover:bg-primary/10 hover:text-primary transition-colors">
                Therapeutic Fostering
              </Link>
              <Link to="/specialisms/emergency-fostering" className="badge-pill hover:bg-primary/10 hover:text-primary transition-colors">
                Emergency Fostering
              </Link>
              <Link to="/specialisms/respite-fostering" className="badge-pill hover:bg-primary/10 hover:text-primary transition-colors">
                Respite Fostering
              </Link>
              <Link to="/specialisms/parent-child-fostering" className="badge-pill hover:bg-primary/10 hover:text-primary transition-colors">
                Parent & Child
              </Link>
              <Link to="/specialisms/teen-fostering" className="badge-pill hover:bg-primary/10 hover:text-primary transition-colors">
                Teen Fostering
              </Link>
            </div>
          </div>
