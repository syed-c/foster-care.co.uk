...
import { Phone, BookOpen, Users, Heart, Shield, MessageCircle, Sparkles } from 'lucide-react';
...
const colorMap: Record<string, { bg: string; icon: string }> = {
  'training': { bg: 'from-blue-500/20 to-blue-600/5', icon: 'text-blue-400' },
  'financial': { bg: 'from-emerald-500/20 to-emerald-600/5', icon: 'text-emerald-400' },
  'emotional': { bg: 'from-rose-500/20 to-rose-600/5', icon: 'text-rose-400' },
  'peer': { bg: 'from-purple-500/20 to-purple-600/5', icon: 'text-purple-400' },
  'helpline': { bg: 'from-amber-500/20 to-amber-600/5', icon: 'text-amber-400' },
  'mentoring': { bg: 'from-cyan-500/20 to-cyan-600/5', icon: 'text-cyan-400' },
