...
const stats = [
  { icon: Award, value: "500+", label: "Agencies Listed" },
  { icon: Users, value: "10K+", label: "Families Helped" },
...
export function TrustSection() {
  const { data: trustContent } = useCmsContentSection("home", "trust");
        ...
        >
          {trustPoints.map((point, index) => (
            ...
            >
              ...
              <div className="relative card-warm group-hover:border-primary/20 transition-all duration-300 h-full">
