...
export function HeroSection() {
  ...
  return <section className="relative min-h-[100svh] md:min-h-[110vh] flex flex-col items-center justify-center pt-20 sm:pt-24 md:pt-28 pb-16 sm:pb-20 md:pb-24 overflow-hidden">
      {/* Background Gradient */}
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <motion.div className="absolute top-36 left-[5%] hidden lg:block opacity-40 will-change-transform" animate={{
        y: [0, -15, 0],
        rotateY: [0, 10, 0],
        rotateX: [0, 5, 0]
      }} transition={{
        ...
        transform: "translateZ(0)"
          ...
          <div className="relative w-48 h-32 rounded-2xl bg-gradient-to-br from-white/80 to-primary/5 shadow-xl shadow-primary/10 border border-white/40 backdrop-blur-sm p-4" style={{
        ...
        <motion.div className="absolute top-48 right-[4%] hidden lg:block opacity-40 will-change-transform" animate={{
        y: [0, 12, 0],
        rotateY: [-5, 5, -5],
        rotateX: [0, -5, 0]
      }} transition={{
        ...
        transform: "translateZ(0)"
          ...
          <div className="relative w-52 h-28 rounded-2xl bg-gradient-to-br from-white/80 to-accent/20 shadow-xl shadow-accent/15 border border-white/40 backdrop-blur-sm p-4" style={{
          transformStyle: "preserve-3d"
        }}>
            ...
            <div className="flex -space-x-2 mt-2">
              {[...Array(4)].map((_, i) => <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-br from-primary/20 to-primary/5 border-2 border-white/50 flex items-center justify-center text-xs font-medium text-primary/60">
                  {["A", "B", "C", "D"][i]}
                </div>)}
        ...
        <motion.div className="absolute bottom-40 left-[8%] hidden md:block opacity-50 will-change-transform" animate={{
        y: [0, -10, 0],
        rotate: [-3, 3, -3],
        scale: [1, 1.05, 1]
      }} transition={{
        ...
        <motion.div className="absolute bottom-52 right-[10%] hidden md:block opacity-50 will-change-transform" animate={{
        y: [0, 8, 0],
        rotate: [3, -3, 3],
        scale: [1, 1.03, 1]
      }} transition={{
        ...
        <motion.div className="absolute top-28 left-[18%] text-primary/10 text-5xl font-extralight select-none will-change-transform hidden sm:block" animate={{
        rotate: [0, 180, 360],
        ...
        <motion.div className="absolute top-56 right-[22%] text-primary/8 text-6xl font-extralight select-none will-change-transform hidden sm:block" animate={{
        rotate: [360, 180, 0],
        ...
        <motion.div className="absolute bottom-72 left-[30%] text-primary/8 text-4xl font-extralight select-none will-change-transform hidden md:block" animate={{
        rotate: [0, -180, -360],
        ...
        <motion.div className="absolute top-1/3 left-[3%] will-change-transform hidden lg:block" animate={{
        y: [0, -25, 0],
        scale: [1, 1.15, 1],
        rotate: [0, 10, 0]
      }} transition={{
        ...
        <motion.div className="absolute top-1/2 right-[3%] will-change-transform hidden lg:block" animate={{
        y: [0, 20, 0],
        scale: [1, 1.2, 1],
        rotate: [0, -15, 0]
      }} transition={{
        ...
        <motion.div className="absolute bottom-1/3 left-[12%] will-change-transform hidden md:block" animate={{
        y: [0, -15, 0],
        scale: [1, 1.1, 1]
      }} transition={{
        duration: 5,
        ...
        <motion.div className="absolute top-44 left-[28%] will-change-transform hidden md:block" animate={{
        y: [0, -20, 0],
        x: [0, 10, 0]
      }} transition={{
        duration: 8,
        ...
        <motion.div className="absolute top-64 right-[28%] will-change-transform hidden md:block" animate={{
        y: [0, 15, 0],
        scale: [1, 1.3, 1]
      }} transition={{
        duration: 6,
        ...
        <motion.div className="absolute bottom-80 left-[40%] will-change-transform hidden lg:block" animate={{
        y: [0, -12, 0],
        x: [0, -8, 0]
      }} transition={{
        duration: 5,
        ...
        <motion.div className="absolute bottom-60 right-[35%] will-change-transform hidden lg:block" animate={{
        y: [0, 18, 0],
        scale: [1, 1.4, 1]
      }} transition={{
        duration: 7,
        ...
        <motion.div className="absolute top-72 left-[6%] hidden xl:block will-change-transform" animate={{
        rotate: [0, 360],
        y: [0, -10, 0]
      }} transition={{
        rotate: {
        ...
        <motion.div className="absolute bottom-80 right-[5%] hidden xl:block will-change-transform" animate={{
        rotate: [0, -360],
        y: [0, 15, 0]
      }} transition={{
        rotate: {
        ...
        <motion.div className="absolute top-96 right-[15%] hidden xl:block will-change-transform" animate={{
        rotate: [0, 180, 0],
        scale: [1, 1.1, 1]
      }} transition={{
        duration: 10,
      ...
      <div className="container-main relative z-10 text-center max-w-5xl mx-auto px-4 sm:px-6">
        ...
        delay: 0.15
          ...
          <span className="text-primary font-semibold relative inline-block min-w-[180px] sm:min-w-[220px]">
            ...
            <motion.span className="inline-block w-[2px] sm:w-[3px] h-[1.1em] bg-primary ml-1 align-middle rounded-full" animate={{
            opacity: [1, 0]
          }} transition={{
            duration: 0.5,
            repeat: Infinity,
        ...
        y: -2
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            {/* Search Button */}
            <Button onClick={handleSearch} className="h-12 sm:h-14 px-6 sm:px-8 rounded-lg sm:rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground font-medium shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all duration-300">
          ...
          return <motion.div key={stat.label} initial={{
            ...
            transition: {
              ...
              stiffness: 300
                ...
                <motion.div className="w-10 h-10 sm:w-14 sm:h-14 rounded-lg sm:rounded-xl bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center group-hover:from-primary/30 group-hover:to-primary/10 transition-all duration-300 shadow-inner" whileHover={{
              rotate: [0, -10, 10, 0],
              transition: {
                duration: 0.5
              }
