...
export function HeroSection() {
  ...
  return (
    <section ref={containerRef} className="relative min-h-[110vh] flex flex-col items-center justify-center pt-28 pb-24 overflow-hidden">
      {/* Background Gradient */}
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        >
          <motion.div
            ...
            className="relative w-48 h-32 rounded-2xl bg-gradient-to-br from-white to-primary/5 shadow-2xl shadow-primary/20 border border-white/50 backdrop-blur-sm p-4"
        ...
        >
          <motion.div
            ...
            className="relative w-52 h-28 rounded-2xl bg-gradient-to-br from-white to-accent/30 shadow-2xl shadow-accent/30 border border-white/60 backdrop-blur-sm p-4"
            style={{ transformStyle: "preserve-3d", perspective: "1000px" }}
          >
            ...
            <div className="flex -space-x-2 mt-2">
              {[...Array(4)].map((_, i) => (
                <div key={i} className="w-8 h-8 rounded-full bg-gradient-to-br from-primary/30 to-primary/10 border-2 border-white flex items-center justify-center text-xs font-medium text-primary">
                  {["A", "B", "C", "D"][i]}
                </div>
              ))}
        ...
        <motion.div 
          ...
          className="absolute top-28 left-[18%] text-primary/25 text-5xl font-extralight select-none"
          animate={{ rotate: [0, 180, 360], opacity: [0.2, 0.35, 0.2] }}
        ...
        <motion.div 
          style={{ y: y2 }}
          className="absolute top-56 right-[22%] text-primary/20 text-6xl font-extralight select-none"
          animate={{ rotate: [360, 180, 0], opacity: [0.15, 0.25, 0.15] }}
        ...
        <motion.div 
          style={{ y: y3 }}
          className="absolute bottom-72 left-[30%] text-primary/15 text-4xl font-extralight select-none"
        ...
        <motion.div 
          style={{ y: y4 }}
          className="absolute top-80 right-[30%] text-accent/40 text-5xl font-extralight select-none"
          animate={{ rotate: [0, 90, 0], opacity: [0.2, 0.3, 0.2] }}
        ...
        <motion.div
          style={{ y: y3 }}
          className="absolute bottom-80 left-[40%]"
        ...
        <motion.div
          style={{ y: y4 }}
          className="absolute bottom-60 right-[35%]"
          animate={{ y: [0, 18, 0], scale: [1, 1.4, 1] }}
        ...
        <motion.div
          style={{ y: y2 }}
          className="absolute top-72 left-[6%] hidden lg:block"
        ...
        <motion.div
          style={{ y: y1 }}
          className="absolute bottom-80 right-[5%] hidden lg:block"
        ...
        <motion.div
          style={{ y: y3 }}
          className="absolute top-96 right-[15%]"
      ...
      <div className="container-main relative z-10 text-center max-w-5xl mx-auto px-4">
        ...
        >
          ...
          <span className="text-primary font-semibold relative inline-block min-w-[220px] text-left">
            ...
            <motion.span 
              className="inline-block w-[3px] h-[1.1em] bg-primary ml-1 align-middle rounded-full" 
              animate={{ opacity: [1, 0] }} 
        ...
        >
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <Button 
              ...
              className="h-14 px-8 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground font-medium shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all duration-300"
            >
        ...
        >
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                <motion.div 
                  className="w-14 h-14 rounded-xl bg-gradient-to-br from-primary/20 to-primary/5 flex items-center justify-center group-hover:from-primary/30 group-hover:to-primary/10 transition-all duration-300 shadow-inner"
