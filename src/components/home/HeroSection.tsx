...
export function HeroSection() {
  ...
  return <section className="relative min-h-screen flex flex-col items-center justify-center pt-24 pb-16 overflow-hidden">
      {/* Background Gradient */}
      ...
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        ...
        <motion.div className="absolute top-28 left-[8%] text-primary/25 text-5xl font-extralight select-none" animate={{
        y: [0, -15, 0],
        rotate: [0, 5, 0],
        ...
        <motion.div className="absolute top-36 right-[12%] text-primary/20 text-6xl font-extralight select-none" animate={{
        y: [0, 12, 0],
        rotate: [0, -8, 0],
        opacity: [0.2, 0.3, 0.2]
      }} transition={{
        ...
        <motion.div className="absolute bottom-44 left-[15%] text-primary/15 text-4xl font-extralight select-none" animate={{
        y: [0, -10, 0],
        x: [0, 5, 0],
        ...
        <motion.div className="absolute bottom-32 right-[8%] text-primary/20 text-5xl font-extralight select-none" animate={{
        y: [0, 15, 0],
        rotate: [0, 10, 0],
        opacity: [0.2, 0.3, 0.2]
      }} transition={{
        ...
        <motion.div className="absolute top-1/3 left-[5%]" animate={{
        y: [0, -20, 0],
        scale: [1, 1.1, 1],
        opacity: [0.15, 0.25, 0.15]
      }} transition={{
        ...
        <motion.div className="absolute top-1/2 right-[6%]" animate={{
        y: [0, 15, 0],
        scale: [1, 1.15, 1],
        opacity: [0.1, 0.2, 0.1]
      }} transition={{
        ...
        {/* Floating Circles */}
        <motion.div className="absolute top-40 left-[20%] w-3 h-3 rounded-full bg-primary/20" animate={{
        y: [0, -25, 0],
        x: [0, 10, 0],
        scale: [1, 1.3, 1]
      }} transition={{
        ...
        <motion.div className="absolute top-60 right-[18%] w-4 h-4 rounded-full bg-accent/40" animate={{
        y: [0, 20, 0],
        scale: [1, 1.2, 1]
      }} transition={{
        duration: 6,
        ...
        <motion.div className="absolute bottom-60 left-[25%] w-2 h-2 rounded-full bg-primary/30" animate={{
        y: [0, -15, 0],
        x: [0, -8, 0]
      }} transition={{
        duration: 5,
        ...
        <motion.div className="absolute bottom-48 right-[22%] w-3 h-3 rounded-full bg-primary/25" animate={{
        y: [0, 18, 0],
        scale: [1, 1.4, 1]
      }} transition={{
        duration: 7,
        ...
        <motion.div className="absolute top-32 left-[3%] opacity-20" animate={{
        y: [0, -10, 0],
        opacity: [0.15, 0.25, 0.15]
      }} transition={{
        duration: 8,
      ...
      <div className="container-main relative z-10 text-center max-w-5xl mx-auto px-4">
        ...
        delay: 0.15
          ...
          <span className="text-primary font-medium relative inline-block min-w-[200px] text-left">
            ...
            <motion.span className="inline-block w-[2px] h-[1em] bg-primary ml-0.5 align-middle" animate={{
            opacity: [1, 0]
          }} transition={{
            duration: 0.6,
            repeat: Infinity,
        ...
        duration: 0.6,
        delay: 0.2
      }} className="text-lg text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed text-center md:text-base">
          {content}
        </motion.p>
        ...
        delay: 0.3
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            {/* Search Button */}
            <Button onClick={handleSearch} className="h-14 px-8 rounded-xl bg-primary hover:bg-primary/90 text-primary-foreground font-medium">
