        ...
        delay: 0.3
          ...
          <div className="flex flex-wrap justify-center gap-3">
            ...
            delay: index * 0.05
                ...
                <Link to={`/locations/england/${region.slug}`} className="inline-flex items-center gap-2 px-5 py-3 rounded-full bg-secondary text-secondary-foreground hover:bg-secondary/80 transition-all duration-300 group">
